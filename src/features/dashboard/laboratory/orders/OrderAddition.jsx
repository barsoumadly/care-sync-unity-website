...
import { addAnalysisOrder } from "../../../../services/analysisOrders";

function OrderAddition() {
  ...
  async function handleSubmit() {
    if (analysisList[0].name) {
      await addAnalysisOrder({ userId: patientId, results: analysisList });
      setAnalysisList([{}]);
      setOpenCard(false);
                  ...
                  <div className="card invoice-info-card">
                    <div className="card-boyd">
                      ...
                      >
                        ...
                        <h4>Start adding analysis tests to patient</h4>
                        <button
